...
const InstalledApp = ({ app, handelUnInstallBtn }) => {
    ...
    return (
        <div className='flex flex-col md:flex-row justify-center items-center  md:justify-between gap-5 shadow-lg  rounded-lg p-4 border border-gray-300'>
            ...
            {/* right div  */}
            <div className=''>
                <button onClick={()=>handelUnInstallBtn(app.id)} className='bg-green-500 text-white font-bold px-5 py-2 rounded-xl'> Uninstall</button>
            </div>
        </div >
